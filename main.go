...
"https://github.com/jophielrivas/ISC315-Tarea5/control"
"https://github.com/jophielrivas/ISC315-Tarea5/share"
)
...
func init() {
	...
	// var err error
	file, err := os.OpenFile("biblos.log",
...
fmt.Print(err)
	...
	fmt.Println("Listado de libros utilizando Titulo: ", tab[0])
	...
	fmt.Println("Listado de libros con utilizando Autor: ", tab[1])
	...
	fmt.Println("Listado de libros utilizando Editora: ", tab[2])
	...
	fmt.Println("Listado de libros utilizando Idioma: ", tab[3])
